...
*/
func (a *ActivitiesApiService) CreateActivity(ctx context.Context, name string, type_ string, startDateLocal time.Time, elapsedTime int32, description string, distance float32, trainer int32, commute int32) (DetailedActivity, *http.Response, error) {
	var (
	...
	localVarFormParams.Add("distance", parameterToString(distance, ""))
	localVarFormParams.Add("trainer", parameterToString(trainer, ""))
	localVarFormParams.Add("commute", parameterToString(commute, ""))
